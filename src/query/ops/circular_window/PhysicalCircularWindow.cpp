...
namespace scidb {
    ...
    class PhysicalCircularWindow: public  PhysicalOperator
    {
    private:
    ...
    public:
        ...
        PhysicalCircularWindow(const string& logicalName, const string& physicalName,
        ...
        std::shared_ptr<Array> execute(vector< std::shared_ptr<Array> >& inputArrays, std::shared_ptr<Query> query)
        {
            ...
            return std::shared_ptr<Array>(new WindowCircularArray(_schema, inputArray, inputAttrIDs, aggregates, method));
        }
    };

    DECLARE_PHYSICAL_OPERATOR_FACTORY(PhysicalCircularWindow, "circular_window", "PhysicalCircularWindow")
